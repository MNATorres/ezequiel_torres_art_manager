...
import { experienceService, uploadService } from '../services/api';
...
export const ExperienceFormModal = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setDate(experience?.date ? experience.date.slice(0, 10) : '');
      setDescription(experience?.description ?? '');
      setImageUrl(experience?.imageUrl);
      setImageFile(null);
      setPreview(experience?.imageUrl ?? null);
      setError('');
    }
  }, [isOpen, experience]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditMode && experience) {
        await experienceService.update(experience._id, payload);
      } else {
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ej. Exposición en el Museo de Bellas Artes"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Contá brevemente de qué se trató esta experiencia"
                />
              </div>
